// FILE: XatlasIOSAppDelegate.swift
...
// Layer: App
// Exports: XatlasIOSAppDelegate, Notification.Name push-registration helpers
...
final class XatlasIOSAppDelegate: NSObject, UIApplicationDelegate {
