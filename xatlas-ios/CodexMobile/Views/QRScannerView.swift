...
struct QRScannerView: View {
    ...
    private func bridgeUpdateView(prompt: CodexBridgeUpdatePrompt) -> some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                bridgeUpdateStep(number: "1", title: "Update xatlas CLE", detail: prompt.command, showsCopyButton: true)
                bridgeUpdateStep(number: "2", title: "Start it again", detail: "Run xatlas-bridge up")
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan QR code from xatlas CLE")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update xatlas CLE on your Mac before scanning",
        message: "This QR code was generated by a different xatlas CLE npm version. Update the package on your Mac to the latest release before scanning a new QR code.",
