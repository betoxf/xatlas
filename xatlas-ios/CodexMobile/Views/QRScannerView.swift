...
struct QRScannerView: View {
    ...
    private func bridgeUpdateView(prompt: CodexBridgeUpdatePrompt) -> some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                bridgeUpdateStep(number: "1", title: "Update xatlas", detail: prompt.command, showsCopyButton: true)
                bridgeUpdateStep(number: "2", title: "Start it again", detail: "Run xatlas up")
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan QR code from xatlas desktop")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update xatlas on your Mac before scanning",
        message: "This QR code was generated by a different xatlas npm version. Update the package on your Mac to the latest release before scanning a new QR code.",
...
private final class QRCameraLifecycleCoordinator {
    ...
    private let queue = DispatchQueue(label: "com.xatlas.qr-camera.lifecycle")
