    ...
    func body(content: Content) -> some View {
        content
            ...
            .alert("Hand off to Mac app", isPresented: $isShowingMacHandoffConfirm) {
                ...
                Text("xatlas will force close and reopen xatlas desktop on your Mac. Any desktop runs in progress will be stopped, and unsaved draft text there may be lost before this chat is opened.")
            }
            .alert(
