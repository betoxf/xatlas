                    ...
                    VStack(spacing: 0) {
                        ...
                        VStack(spacing: 22) {
                            ...
                            VStack(spacing: 8) {
                                ...
                                Text("Control your AI agents from your iPhone.")
                            ...
                            VStack(spacing: 14) {
                                ...
                                VStack(spacing: 14) {
                                    OnboardingStepRow(
                                        number: "1",
                                        title: "Install your agent CLI",
                                        subtitle: "Claude Code or Codex"
                                    )

                                    OnboardingStepRow(
                                        number: "2",
                                        title: "Launch the xatlas desktop app",
                                        command: "open xatlas.app"
                                    )

                                    OnboardingStepRow(
                                        number: "3",
                                        title: "Scan QR code from Settings",
                                        subtitle: "Settings → Remote Access → Show QR"
                                    )
                                }
                            }
