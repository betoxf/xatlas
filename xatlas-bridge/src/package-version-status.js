...
// Purpose: Reads the installed Xatlas package version and caches the latest published npm version.
// Layer: CLI helper
...
const XATLAS_REGISTRY_URL = "https://registry.npmjs.org/xatlas-bridge/latest";
...
function createBridgePackageVersionStatusReader({
  ...
  registryUrl = XATLAS_REGISTRY_URL,
