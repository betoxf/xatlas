...
/// The main content surface that fills the right panel. Renders one of:
/// dashboard, workspace tabs (with terminal/editor + command bar),
/// catalog sections, or an empty state. Owns the tab bar above the
